...
export default function Header(){
  return (
    <header className="bg-white/80 backdrop-blur sticky top-0 z-50 border-b border-slate-200/70 shadow-sm">
      <div className="container mx-auto flex items-center justify-between py-4 px-4">
        <div className="flex items-center gap-3">
          <div className="h-10 w-10 rounded-full bg-gradient-to-br from-brandBlue to-blue-600 text-white flex items-center justify-center shadow-lg">
            <HeartHandshake className="h-5 w-5" />
          </div>
          <div>
            <p className="text-sm text-slate-500">جمعية النور</p>
